...
function w_pokaz_koszyk_dropdown()
{
    ...
    echo '<a style="color: #303030; font-weight: bold" href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Koszyk ('.sprawdz_liczbe_w_koszyku().') <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a>';
