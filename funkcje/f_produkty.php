...
//wyświetla karuzelę z promocjami
function karuzela()
{
echo '<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <a href="index.php?liczba_na_strone=0&str=1&kat=2"><img src="img/karuzela/warzywa.jpg" alt="Warzywa"></a>
    ...
    <div class="item">
      <a href="index.php?liczba_na_strone=0&str=1&kat=5"><img src="img/karuzela/chleb.jpg" alt="Pieczywa"></a>
      <div class="carousel-caption">
        <h3></h3>
        <p></p>
      </div>
    ...
    <div class="item">
      <a href="index.php?liczba_na_strone=0&str=1&kat=1"><img src="img/karuzela/fresh-juice.png" alt="Soki"></a>
      <div class="carousel-caption">
        <h3></h3>
        <p></p>
      </div>
