...
<form class="well form-horizontal" action="?v=tresc/rejestracja/rejestracja" method="post"  id="rejestracja" accept-charset="utf-8">

        

<!-- Form Name -->
<legend><center><h2><b>Rejestracja do sklepu</b></h2></center></legend><br>
...
<div class="form-group">
  ...
  <div class="col-md-5"><br>
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <button type="submit" name="submit" class="btn btn-warning" > &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspZAREJESTRUJ <span class="glyphicon glyphicon-send"></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>
  </div>
</div>
