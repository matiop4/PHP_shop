 ...
 */
    ...
    if(dodaj_do_koszyka($_GET['id_produktu']))
    {
        ...
        header("Location: index.php?v=tresc/koszyk/duzy_koszyk&id_produktu={$_GET['id_produktu']}&dodano_do_koszyka=tak");
    }
    else
    {
         // gdy jednak się coś nie powiedzie, wyświetlamy komunikat o błędzie
        header("Location: index.php?v=tresc/koszyk/duzy_koszyk&id_produktu={$_GET['id_produktu']}&dodano_do_koszyka=nie");
    }
